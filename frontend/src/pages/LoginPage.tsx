        ...
        <div className="bg-surface py-8 px-6 shadow-card border border-border sm:rounded-xl sm:px-10">
          ...
          <div className="mt-6 pt-6 border-t border-border">
            <button
              onClick={handleDemo}
              disabled={loading}
              className="w-full py-2.5 px-4 border border-border rounded-lg text-sm font-semibold text-text bg-surface-2 hover:bg-border/60 transition-colors"
            >
              Explore as Demo Analyst (No Signup)
            </button>
          </div>
        </div>
      </div>
